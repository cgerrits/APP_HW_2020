...
public class BinarySearchTree<T extends Comparable<? super T>, E> {
    /**
     ...
     */
    public BinarySearchTree(T key, E value) {
        this.key = key;
        this.value = value;
        subTreeValue = 0;
    }
     ...
     */
    public BinarySearchTree<T, E> findTree(T k) {
        if(isLeaf()) return null;
     ...
     */
    public BinarySearchTree<T, E> maxTree() {
     ...
     * @return minimum tree
     */
    public BinarySearchTree<T, E> minTree() {
     ...
     */
    public BinarySearchTree<T, E> remove(T k) {
        int factor = k.compareTo( key );
        ...
        if(factor == 0) {
            ...
            if(left != null && right != null) {
                BinarySearchTree<T, E> max = left.maxTree();
                remove( max.key );
                max.right = right;
                max.left = left;
                return max;
