...
public class IdentifactionKey<T> {
    private String question;

    private IdentifactionKey<T> current;
    /**
     ...
     */
    private IdentifactionKey<T> left;

    /**
     * Tree hanging on the right side
     */
    private IdentifactionKey<T> right;

    /**
     * Empty constructor
     */
    public IdentifactionKey() {
    }
     ...
     */
    public IdentifactionKey(T value) {
        this.value = value;
    }

    public IdentifactionKey(T value, String question) {
        this.value = value;
    ...
    public IdentifactionKey<T> navigate(boolean answer) {
        if (answer) return getRight();
        else return getLeft();
    }

    public void extend(String question, T species) {
        IdentifactionKey<T> newNode = new IdentifactionKey<>(null, question);
        newNode.addLeft(this.left);
        newNode.addRight(species);
     ...
     */
    public IdentifactionKey<T> getRight() {
        return right;
    }
     ...
     * @return tree on left
     */
    public IdentifactionKey<T> getLeft() {
        return left;
    }
     ...
     * @return added tree
     */
    public IdentifactionKey<T> addLeft(T value) {
        left = new IdentifactionKey<>(value);
        return left;
    }
     ...
     * @return added tree
     */
    public IdentifactionKey<T> addLeft(IdentifactionKey<T> left) {
        this.left = left;
        return left;
    }
     ...
     * @return added tree
     */
    public IdentifactionKey<T> addRight(T value) {
        right = new IdentifactionKey<>(value);
        return right;
    }
     ...
     * @return added tree
     */
    public IdentifactionKey<T> addRight(IdentifactionKey<T> right) {
        this.right = right;
        return right;
    }
